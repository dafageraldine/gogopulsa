...
import '../../class.dart';
import 'subpulsaseluler/pembayaran.dart';

class Plntoken extends StatefulWidget {
  @override
  _PlntokenState createState() => _PlntokenState();
}

class _PlntokenState extends State<Plntoken> {
  ...
  Future getlist() async {
    ...
    http.Response ceks = await http.get(
      Uri.parse(baseurl + "public/api/data/produk?tipe=PLN"),
      headers: {
        // "Content-Type": "application/x-www-form-urlencoded",
        'apiKey':
            '632e93023886160a2a5494cd49aeb72994fc61f6834355d175a423b99715a9df',
